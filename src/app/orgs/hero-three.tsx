                    ...
                    <div className="lg:pr-8">
                        <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
                            ...
                            <p className="mt-6 text-base font-normal leading-7 text-gray-900">
                                At [Your Company Name], we specialize in providing high-quality service solutions, tailored to meet the unique needs of our clients. With a dedicated team of experts, we bring your ideas to life and help your business thrive.
                            </p>
                            <p className="mt-8 text-base font-bold text-gray-900">Join us and bring your vision to life</p>
                            ...
                            <div className="flex justify-start w-full gap-6 pb-8 overflow-x-auto snap-x">
                                ...
                                <div className="relative snap-start scroll-ml-6 shrink-0 first:pl-6 last:pr-6">
                                    <div className="relative flex flex-col overflow-hidden transition-all duration-200 transform bg-white border border-gray-100 shadow w-60 md:w-80 group rounded-xl hover:shadow-lg hover:-translate-y-1">
                                        <a href="#" title="Explore Our Services" className="flex shrink-0 aspect-w-4 aspect-h-3">
                                            <img className="object-cover w-full h-full transition-all duration-200 transform group-hover:scale-110" src="https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/4/thumbnail-1.png" alt="Service Thumbnail" />
                                        </a>
                                        <div className="flex-1 px-4 py-5 sm:p-6">
                                            <a href="#" title="Explore Our Services" className="">
                                                <p className="text-lg font-bold text-gray-900">Tailored Solutions for Every Industry</p>
                                                <p className="mt-3 text-sm font-normal leading-6 text-gray-500 line-clamp-3">From startups to enterprises, we deliver scalable solutions customized to your business needs.</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="relative snap-start scroll-ml-6 shrink-0 first:pl-6 last:pr-6">
                                    <div className="relative flex flex-col overflow-hidden transition-all duration-200 transform bg-white border border-gray-100 shadow w-60 md:w-80 group rounded-xl hover:shadow-lg hover:-translate-y-1">
                                        <a href="#" title="Discover Our Process" className="flex shrink-0 aspect-w-4 aspect-h-3">
                                            <img className="object-cover w-full h-full transition-all duration-200 transform group-hover:scale-110" src="https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/4/thumbnail-2.png" alt="Process Thumbnail" />
                                        </a>
                                        <div className="flex-1 px-4 py-5 sm:p-6">
                                            <a href="#" title="Discover Our Process" className="">
                                                <p className="text-lg font-bold text-gray-900">Streamlined Process for Success</p>
                                                <p className="mt-3 text-sm font-normal leading-6 text-gray-500 line-clamp-3">Learn about our collaborative approach that ensures quality and efficiency at every step.</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="relative snap-start scroll-ml-6 shrink-0 first:pl-6 last:pr-6">
                                    <div className="relative flex flex-col overflow-hidden transition-all duration-200 transform bg-white border border-gray-100 shadow w-60 md:w-80 group rounded-xl hover:shadow-lg hover:-translate-y-1">
                                        <a href="#" title="Our Team in Action" className="flex shrink-0 aspect-w-4 aspect-h-3">
                                            <img className="object-cover w-full h-full transition-all duration-200 transform group-hover:scale-110" src="https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/4/thumbnail-3.png" alt="Team Thumbnail" />
                                        </a>
                                        <div className="flex-1 px-4 py-5 sm:p-6">
                                            <a href="#" title="Our Team in Action" className="">
                                                <p className="text-lg font-bold text-gray-900">Your Trusted Team of Experts</p>
                                                <p className="mt-3 text-sm font-normal leading-6 text-gray-500 line-clamp-3">Meet the talented professionals who make it all possible.</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
...
//                                     <a href="#" title="" className="flex shrink-0 aspect-w-4 aspect-h-3"
//                                     ><img
//                                             className="object-cover w-full h-full transition-all duration-200 transform group-hover:scale-110" src="https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/4/thumbnail-3.png" alt="thumbnail-3"
//                                         /></a>
//                                     <div className="flex-1 px-4 py-5 sm:p-6">
//                                         <a href="#" title="" className="">
//                                             <p className="text-lg font-bold text-gray-900">How to write content about your photographs</p>
