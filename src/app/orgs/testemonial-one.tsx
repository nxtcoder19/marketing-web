            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                    <div className="text-center">
                        <p className="text-lg font-medium text-gray-600 font-pj">Thousands of satisfied clients trust us</p>
                            ...
                            <div className="flex flex-col overflow-hidden shadow-xl">
                                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                    <div className="flex-1">
                                        ...
                                        <blockquote className="flex-1 mt-8">
                                            <p className="text-lg leading-relaxed text-gray-900 font-pj">
                                                “Your team has exceeded our expectations! The solutions you provided streamlined our workflow and brought our project to life.”
                                            </p>
                                        </blockquote>
                                    </div>
                                    ...
                                    <div className="flex items-center mt-8">
                                        ...
                                        />
                                        <div className="ml-4">
                                            <p className="text-base font-bold text-gray-900 font-pj">John Smith</p>
                                            <p className="mt-0.5 text-sm font-pj text-gray-600">CEO, Startup Co.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col overflow-hidden shadow-xl">
                                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                    <div className="flex-1">
                                        ...
                                        <blockquote className="flex-1 mt-8">
                                            <p className="text-lg leading-relaxed text-gray-900 font-pj">
                                                “The team’s professionalism and commitment to excellence were evident throughout the project. Highly recommended!”
                                            </p>
                                        </blockquote>
                                    </div>
                                    ...
                                    <div className="flex items-center mt-8">
                                        ...
                                        />
                                        <div className="ml-4">
                                            <p className="text-base font-bold text-gray-900 font-pj">Emily Davis</p>
                            ...
                            <div className="flex flex-col overflow-hidden shadow-xl">
                                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                    <div className="flex-1">
                                        ...
                                        <blockquote className="flex-1 mt-8">
                                            <p className="text-lg leading-relaxed text-gray-900 font-pj">
                                                “The innovative solutions provided by the team have greatly impacted our efficiency and client satisfaction.”
                                            </p>
                                        </blockquote>
                                    </div>
                                    ...
                                    <div className="flex items-center mt-8">
                                        ...
                                        />
                                        <div className="ml-4">
                                            <p className="text-base font-bold text-gray-900 font-pj">Sophia Lee</p>
                                            <p className="mt-0.5 text-sm font-pj text-gray-600">Operations Head</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
