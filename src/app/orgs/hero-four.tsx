        ...
        <div className="">
            <section className="relative py-12 bg-white sm:py-16 lg:py-20">
                <div className="absolute inset-0">
                    <img className="object-cover w-full h-full" src="https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/5/grid-pattern.png" alt="Background Grid Pattern" />
                </div>

                <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="max-w-xl mx-auto text-center">
                        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl lg:text-5xl">Empowering Businesses with Exceptional Service Solutions</h1>
                        <p className="max-w-md mx-auto mt-6 text-base font-normal leading-7 text-gray-500">
                            Our mission is to help businesses succeed by providing tailored, high-quality service solutions. Let us turn your vision into reality with our dedicated expertise.
                        </p>
                        ...
                        <form action="#" method="POST" className="max-w-md mx-auto mt-8 space-y-4 sm:space-x-4 sm:flex sm:space-y-0 sm:items-end">
                            <div className="flex-1">
                                ...
                                <div>
                                    <input type="email" name="email" id="email" className="block w-full px-4 py-3 sm:py-3.5 text-base font-medium text-gray-900 placeholder-gray-500 border border-gray-300 rounded-lg sm:text-sm focus:ring-gray-900 focus:border-gray-900" placeholder="Email address" />
                                </div>
                            </div>
                        ...
                        <ul className="flex items-center justify-center mt-6 space-x-6 sm:space-x-8">
                            <li className="flex items-center">
                                ...
                                <span className="text-xs font-medium text-gray-900 sm:text-sm"> Trusted by 100+ clients </span>
                            </li>
                            ...
                            <li className="flex items-center">
                                ...
                                <span className="text-xs font-medium text-gray-900 sm:text-sm"> Delivering excellence for 5+ years </span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="flex w-full gap-6 pb-8 mt-12 overflow-x-auto sm:mt-16 lg:mt-20 snap-x">
                        ...
                        <div className="overflow-hidden w-[300px] lg:w-[420px] transition-all duration-200 transform bg-white border border-gray-200 rounded-2xl hover:shadow-lg hover:-translate-y-1">
                            <div className="px-4 py-5 sm:p-5">
                                <div className="flex items-start lg:items-center">
                                    <a href="#" title="Explore Services" className="shrink-0">
                                        <img className="lg:h-24 w-14 h-14 lg:w-24 rounded-xl object-cover" src="https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/5/thumbnail-1.png" alt="Service Thumbnail" />
                                    </a>

                                    <div className="flex-1 ml-4 lg:ml-6">
                                        <p className="text-xs font-medium text-gray-900 lg:text-sm">
                                            <a href="#" title="Explore Services" className=""> Our Expertise </a>
                                        </p>
                                        <p className="mt-2 text-sm font-bold text-gray-900 lg:text-lg group-hover:text-gray-600">
                                            <a href="#" title="Explore Services" className=""> Customized solutions tailored for your business </a>
                                        </p>
                                        <p className="mt-2 text-xs font-medium text-gray-500 lg:text-sm">Updated: January 2025</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Additional Cards */}
                    {[...Array(4)].map((_, idx) => (
                        <div key={idx} className="relative snap-center scroll-ml-6 shrink-0 first:pl-6 last:pr-6">
                            <div className="overflow-hidden w-[300px] lg:w-[420px] transition-all duration-200 transform bg-white border border-gray-200 rounded-2xl hover:shadow-lg hover:-translate-y-1">
                                <div className="px-4 py-5 sm:p-5">
                                    <div className="flex items-start lg:items-center">
                                        <a href="#" title={`Card ${idx + 2}`} className="shrink-0">
                                            <img className="lg:h-24 w-14 h-14 lg:w-24 rounded-xl object-cover" src={`https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/5/thumbnail-${idx + 2}.png`} alt={`Thumbnail ${idx + 2}`} />
                                        </a>

                                        <div className="flex-1 ml-4 lg:ml-6">
                                            <p className="text-xs font-medium text-gray-900 lg:text-sm">
                                                <a href="#" title={`Category ${idx + 2}`} className=""> Our Solutions </a>
                                            </p>
                                            <p className="mt-2 text-sm font-bold text-gray-900 lg:text-lg group-hover:text-gray-600">
                                                <a href="#" title={`Card ${idx + 2}`} className=""> Delivering value through seamless execution </a>
                                            </p>
                                            <p className="mt-2 text-xs font-medium text-gray-500 lg:text-sm">Updated: January 2025</p>
                                        </div>
                                    </div>
