                ...
                <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-y-4 lg:items-center lg:grid-cols-2 xl:grid-cols-2">
                        <div className="text-center xl:col-span-1 lg:text-left md:px-16 lg:px-0 xl:pr-20">
                            <h1 className="text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:text-5xl lg:leading-tight font-pj">Transforming Your Vision into Reality</h1>
                            <p className="mt-2 text-lg text-gray-600 sm:mt-6 font-inter">
                                At [Your Company Name], we specialize in delivering tailored service solutions that cater to your unique business needs. From concept to completion, we are your trusted partner in driving results.
                            </p>

                            <a href="#" title="Contact Us" className="inline-flex px-8 py-4 mt-8 text-lg font-bold text-white transition-all duration-200 bg-gray-900 border border-transparent rounded sm:mt-10 font-pj hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900" role="button">
                                Get in Touch
                            </a>

                            <div className="mt-8 sm:mt-16">
                                <blockquote className="mt-6">
                                    <p className="text-lg font-bold text-gray-900 font-pj">“Professional, reliable, and results-driven.”</p>
                                    <p className="mt-3 text-base leading-7 text-gray-600 font-inter">Our clients trust us to deliver high-quality services that exceed expectations. Let us take your business to new heights.</p>
                                </blockquote>
                                ...
                                <div className="flex items-center justify-center mt-3 lg:justify-start">
                                    ...
                                    <p className="ml-2 text-base font-bold text-gray-900 font-pj">Sarah Williams, Client</p>
                                </div>
                            </div>
                        </div>

                        <div className="xl:col-span-1">
                            <img className="w-full mx-auto" src="https://cdn.rareblocks.xyz/collection/clarity/images/hero/1/illustration.png" alt="Team collaboration illustration" />
                        </div>
                    </div>
                </div>
            </section>
